...
- 📑 **발행용 PDF (12pp)**: [`paper/paper.pdf`](paper/paper.pdf)
...
- [무엇이 들어있나 (10개 섹션)](#무엇이-들어있나-10개-섹션)
- [그림](#그림)
- [방법론·정직성](#방법론정직성)
- [정직한 한계](#정직한-한계)
- [어떻게 만들었나](#어떻게-만들었나)
...
| 3 | **디자인·마케팅** | "AI 티" 제거: **측정 가능한 21개 텔 + Tell Score(리팩터로 76→0)** [The Tells](https://labs.iovstudio.kr/ko/papers/ai-design-tells) 흡수, 왜 다 보라 그라데이션인가, 디자인 시스템 템플릿, 판별 체크리스트 |
...
| 7 | **한국 기업 맥락** | 국산 LLM(HyperCLOVA X·Solar·EXAONE)·도입 현황(55.7%)·소버린 AI, 언제 국산 vs 글로벌, **한국 도입 사례**(삼성·GS칼텍스·HD현대미포·TYM) |
| 8 | **업종별 레시피** | 제조·금융·리테일·의료 우선 유스케이스와 함정, Klarna 하이브리드 교훈(딜로이트 통합 60%) |
| 9 | 치트시트 | 한 페이지 의사결정 요약 |
| 10 | 출처 | 1차/보조 구분, 검증 상태 |
...
<tr>
<td colspan="2" align="center"><img alt="tell score" src="paper/figs/fig7_tell_score.png" width="72%"><br><sub><b>Fig 7.</b> "AI 디자인 룩"은 측정·제거 가능하다. 같은 페이지에서 텔 요소만 교체해 Tell Score 76(F)→0(A). IOV Labs <a href="https://labs.iovstudio.kr/ko/papers/ai-design-tells">The Tells</a>, 202개 실제 사이트 검증.</sub></td>
</tr>
</table>
...
- 디자인 "AI 티"는 IOV의 The Tells(202개 사이트 검증)로 보강했으나, 일부 UI/UX 실무 팁과 노코드 vs 커스텀 ROI는 여전히 블로그 근거가 많다(미검증 표기). 업종 레시피·한국 사례는 보도/벤더 발표라 자체 검증 전제.
