...
- *보안*: OWASP LLM Top 10(특히 프롬프트 인젝션·과도 에이전시), NIST AI RMF로 통제. 섀도우 AI 카탈로그·DLP, 에이전트 최소권한·HITL.
