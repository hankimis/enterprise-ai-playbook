...
> 📐 **관련 연구**: 이 "AI 디자인 룩"을 21개의 **측정 가능한 텔(tell)** 로 분해하고 Tell Score 탐지기·하네스로 정량화한 IOV Labs 연구 [**The Tells**](https://labs.iovstudio.kr/ko/papers/ai-design-tells) ([GitHub](https://github.com/hankimis/ai-design-tells)). 본 절의 "AI 티" 판별을 체계적으로 자동화하려면 참고.
